...
// function checkCollectionStart() {
//   adRef.once("value", (snapshot) => {
//     return isWithinCollectionPeriod(snapshot.val());
//   });

//   function isWithinCollectionPeriod(details) {
//     const currDate = new Date();
//     // const currDate = new Date(2020, 5, 12);
...
//       ) {
//         console.log("within collection hours");
//         return true;
//       } else {
...
// let x = checkCollectionStart();

// console.log("result", x);

// let isWithinCollectionPeriod = checkCollectionStart();

// console.log("isWithinCollectionPeriod", isWithinCollectionPeriod);
